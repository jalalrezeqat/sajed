...
@section('content')
    ...
    <div class="formaddm">
        <form action="{{ url('admin/sliderteacher1/add') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="cars">اختار الصفحة :</label>
                <select class="form-control" name="mobile_dsktop" id="mobile_dsktop">
                    <option name="mobile_dsktop" value="1">كمبيوتر</option>
                    <option name="mobile_dsktop" value="2">هاتف</option>
                </select>
            </div>
