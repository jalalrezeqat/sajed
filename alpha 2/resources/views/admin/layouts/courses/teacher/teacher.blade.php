...
@section('content')
    <div>
        ...
        <a href="{{ route('admin.teacher.viweaddteacher') }}"><button class="btnaboutadd btn btn-dark">اضافة الى
                المعلم</button></a>
                ...
                @foreach ($tetcher as $tetchers)
                    <tr>
                        <td class="tdnamecontectus "><img class="img-slider"
                                src="{{ asset('img/teacher/' . $tetchers->img) }}" alt=""></td>
                        ...
                        <td class=""> <a href="{{ route('admin.teacher.edit', $tetchers->id) }}"
                                class="btn btn-success editdelete">تعديل</a>
                            <a href="{{ route('admin.teacher.destroy', $tetchers->id) }}"
