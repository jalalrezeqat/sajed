    ...
    <?php $__env->startSection('content'); ?>
        <div class="dir ">
            <a href="<?php echo e(route('admin.addAdmin')); ?>"><button class="btn btn-back-user btn-lg btn-success">رجوع</button></a>

            <div class="form-edit-user-profile">
                <form action="<?php echo e(route('admin.postChangePasswordadminrouel', $user->id)); ?>" method="POST"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/sajed/alpha/resources/views/Admin/roule/editpassword.blade.php ENDPATH**/ ?>