<?php $__env->startSection('content'); ?>
    <div class="formaddm">
        ...
        <form action="<?php echo e(route('admin.courses.lessonadd1', $chabterid)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/sajed/alpha/resources/views/admin/layouts/courses/courses/lessonadd.blade.php ENDPATH**/ ?>