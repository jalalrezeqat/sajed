...
<div class="formaddm">
    <form action="<?php echo e(url('admin/branch/update/'.$branch->id)); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PUT'); ?>

        <div class="form-group">
          <label for="inputtitelmistion">اسم الفرع </label>
          <input type="text" class="form-control" name='name' value="<?php echo e($branch->name); ?>" id="name" placeholder="عنوان المهة">
        </div>
        <div class="form-group">
          <label for="inputtitelmistion">ملخص الفرع</label>
          <input type="text" class="form-control" name='summary' value="<?php echo e($branch->summary); ?>" id="summary" placeholder="نص المهمة">
        </div>
