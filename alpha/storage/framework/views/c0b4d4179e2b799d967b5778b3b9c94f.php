<?php $__env->startSection('content'); ?>
    <div class="dir edit-user-profile">
        <a href="<?php echo e(url('admin/dashboard/profile/' . Auth::guard('admin')->user()->id)); ?>"><button
                class="btn btn-back-user btn-lg btn-success">رجوع</button></a>

        <div class="form-edit-user-profile">
            <form action="<?php echo e(route('admin.postChangePasswordadmin')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/sajed/alpha/resources/views/Admin/password.blade.php ENDPATH**/ ?>