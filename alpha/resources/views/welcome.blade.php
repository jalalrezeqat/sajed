...
">
      ...
      @endforeach
      @vite(['resources/css/mediaipad.css', 'resources/css/vedio.css'])
                      ...
                      <div class="col-lg-5 col-md-7 col-sm-9 ">
                          ...
                          <div id="carouselExample" class="carousel  shadow-sm  slide">
                              <div class="carousel-inner">
                                  ...
                                  {{-- @foreach ($sliderteachermob as $key => $sliderteachermobs)
                                      <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                                          <img class="d-block d-block  img-1 img-slider-teacher"
                                              src="{{ asset('img/sliderphone/' . $sliderteachermobs->img) }}"
                              ...
                              <div class="vidio " style="height: 50%;width: 80%;margin: auto;">
                                  @foreach ($aboutmore as $aboutmores)
                                      <video style="height: 50%;width: 80%;margin: auto;" controls autoplay
                                          ...
                                          <source src="{{ asset('img/aboutmore/' . $aboutmores->vedio) }}"
