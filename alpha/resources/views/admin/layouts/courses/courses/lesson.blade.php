            ...
            <tbody>
                @foreach ($lesson as $lesson)
                    <tr>
                        ...
                        <td class="">{{ $chabter->name }} </td>

                        <td class="">
                            <a href="{{ route('admin.courses.lesson.viwe1', $lesson->id) }}"
                                class="btn btn-info editdelete">مشاهدة الدرس </a>
                            <a href="{{ route('admin.lesson.edit', $lesson->id) }}" class="btn btn-success editdelete">تعديل
                            </a>
                            <a href="{{ route('admin.lesson.destroy', $lesson->id) }}"
