...
@section('content')
    <div>
        ...
        <a href="{{ route('admin.courses.questionscoursadd', $courses->id) }}"><button class="btnaboutadd btn btn-dark">اضافة
            ...
            <tbody>
                @foreach ($questionscours as $questionscours)
                    <tr>
                        ...
                        <td class="">
                            <a href="{{ route('admin.questionscours.edit', $questionscours->id) }}"
                                class="btn btn-dark editdelete">تعديل </a>

                            <a href="{{ route('admin.questionscours.destroy', $questionscours->id) }}"
