    ...
    @section('content')
        <div class="dir ">
            <a href="{{ route('admin.addAdmin') }}"><button class="btn btn-back-user btn-lg btn-success">رجوع</button></a>

            <div class="form-edit-user-profile">
                <form action="{{ route('admin.postChangePasswordadminrouel', $user->id) }}" method="POST"
