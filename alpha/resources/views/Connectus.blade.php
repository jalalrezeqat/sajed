                            ...
                            <div class="row">
                                <div class="col ring">
                                    <div class="text-center">
                                        <p style="font-size: 42px">تواصل معنا الآن!</p>
                                ...
                                <div class="col">
                                    ...
                                    <div class=" contectusdet">
                                        ...
                                        <p class="mb-3 dir"><img width="30px" height="20px" src="img/mail.png"
                                                alt=""> info@alpha.ps</p>
                                    </div>
                                </div>
                        ...
                        <form class="contectus-form dir" action="{{ url('Connectus') }}" method="POST">
                            ...
                            <div class="row gy-4 gy-xl-2 p-4 p-xl-5">
                                <div class="col-12 col-md-6">
                                    <label for="fname" class="form-label">الاسم الاول <span
                                            class="text-danger"></span></label>
                                    <div class="input-group">
                                        <input type="fname" class="form-control" id="firestname" name="firestname"
                                            value="" required>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                ...
                                <div class="col-12">
                                    <label for="pohne" class="form-label">رقم الهاتف <span
                                            class="text-danger"></span></label>
                                    <input type="pohne" class="form-control" id="phone" name="phone" value=""
                                        required>
                                </div>
