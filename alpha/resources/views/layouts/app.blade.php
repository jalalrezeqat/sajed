                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav links justify-content-center navbar-collapse mb-2 mb-lg-0">
                            <li class="nav-item-home">
                                <a class="nav-link  active " tabindex="1" aria-current="page"
                                    href="{{ url('/') }}"><button
                    ...
                    <div class="col-lg-3 ">
                        ...
                        <ul class="list-unstyled">
                            ...
                            @foreach ($connectwithus as $connectwithus)
                                <li>
                                    <p><i class="fas"></i>{{ $connectwithus->email }}</p>
                                </li>
                                <li>

                                    <p style="direction: ltr;">{{ $connectwithus->phone }}</p>
                                </li>
                            @endforeach
                        ...
                        <div class="tabs">
                            ...
                            <div class="row gy-3 gy-md-4 gy-lg-0 align-items-md-center">
                                            ...
                                            <div class="d-flex mb-5">
                                                <div class="justify-content-xl-center  ">
                                                    <div class="d-flex ">
                                                        ...
                                                        <img class="img-fluid  p-2" src="img/login.png"
                                                            alt="">
                                                        {{-- @endforeach --}}
                                ...
                                <div class="col-12 col-lg-5 dir">
                                    ...
                                    <p class="dir text-center ">أنتَ الآن أحد المشاركين في رحلة الـ 99.7</p>
                                        ...
                                        <div class="row gy-4 gy-xl-2 p-4 p-xl-5">
                                            ...
                                            <div class="col-12 inpout-email">
                                                <input type="password" class="form-control" id="password"
                                                    name="password" value="" placeholder="كلمة المرور"
                                                    required>
                                            </div>
                                            <div class="col-12 inpout-email">
                ...
                <div class="Scriptcontent">
                    ...
                    <div class="modal-content">
                        ...
                        <h1 class="mb-3 dir text-center ">مرحباً بك في ألفا</h6>
                            <p class="mb-3 dir text-center ">أنشئ حسابك وتابع دروسك بشكل إلكترونيّ وبجودة عالية
                            </p>
                                    ...
                                    <div class="col-12 col-md-5 float-reg dir ">
                                        ...
                                        <div class="input-group  form-control dir ">
                                            <label for="" class="form-check-label"
                                                for="inlineCheckbox1">الفرع :</label>
