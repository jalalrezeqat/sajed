    ...
    <div class="boxcolabssshow">
      <div class="">
         <div class="chabternamecollabsshow">
              ...
              <button type="button"  data-bs-toggle="collapse" data-bs-target="#collapse{{$chbters->id}}" aria-expanded="false" aria-controls="collapseExample" class="btn qustion-text "style="font-size:14px;"> <p class="buttonshow">{{$chbters->name}} </p></button>
         </div>
      </div>
    </div>
